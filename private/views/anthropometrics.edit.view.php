 <main>
        <h1>Anthropometrics Edit</h1>
        <div class="add-form">
            <h2>Anthropometrics</h2>
            <div class="form-section">
                <form method="post" action="<?php ROOT . '/anthropometrics/edit/' . child_id_URL() ?>">
                        ...
                        <div class="form-column">
                            ...
                            <div class="select-wrapper">
                                <select  id="weight_metric_select" name="weight_metric" onchange="updateWeight()" <?= get_var('weight_metric') ?>>
                                    ...
                                    <option <?= get_var('weight_metric', $row[0]->weight_metric ) == 'kilograms' ? 'selected' : '' ?> value="kilograms">Kilograms</option>
                                    <option <?= get_var('weight_metric', $row[0]->weight_metric) == 'pounds' ? 'selected' : '' ?> value="pounds">Pounds</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-column">
                        ...
                        <div class="form-column">
                            ...
                            <div class="select-wrapper">
                                <select  id="length_metric_select" name="length_metric" onchange="updateLength()" <?= get_var('length_metric') ?>>
                                    <option value="" disabled selected>Select</option>
                                    <option <?= get_var('length_metric', $row[0]->length_metric) == 'cm' ? 'selected' : '' ?> value="cm">Centimeters</option>
                                    <option <?= get_var('length_metric', $row[0]->length_metric) == 'inches' ? 'selected' : '' ?> value="inches">Inches</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-column">
                        ...
                        <div class="form-column">
                            ...
                            <div class="select-wrapper">
                                <select id="head_metric_select" name="head_metric" onchange="updateHead()" <?= get_var('head_metric') ?>>
                                    <option value="" disabled selected>Select</option>
                                    <option <?= get_var('head_metric',$row[0]->head_metric) == 'cm' ? 'selected' : '' ?> value="cm">Centimeters</option>
                                    <option <?= get_var('head_metric', $row[0]->head_metric) == 'inches' ? 'selected' : '' ?> value="inches">Inches</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-column">
                            <label for="head">Head Circumference</label>
                            <input type="text" id="head" name="head" value="<?= get_var('head', $row[0]->head) ?>" required />
                        </div>
                    </div>
                        ...
                        <div class="form-column">
                            ...
                            <div class="select-wrapper">
                                <select id="chest_metric_select" name="chest_metric" onchange="updateChest()"  <?= get_var('chest_metric') ?>>
                                    <option value="" disabled selected>Select</option>
                                    <option <?= get_var('chest_metric', $row[0]->chest_metric) == 'cm' ? 'selected' : '' ?> value="cm">Centimeters</option>
                                    <option <?= get_var('chest_metric', $row[0]->chest_metric) == 'inches' ? 'selected' : '' ?> value="inches">Inches</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-column">
                            <label for="chest">Chest Circumference</label>
                            <input type="text" id="chest" name="chest" value="<?= get_var('chest', $row[0]->chest) ?>" required />
                        </div>
                    </div>
                        ...
                        <div class="form-column">
                            ...
                            <div class="select-wrapper">
                                <select id="abdomen_metric_select" name="abdomen_metric" onchange="updateAbdomen()" <?= get_var('abdomen_metric') ?>>
                                    <option value="" disabled selected>Select</option>
                                    <option <?= get_var('abdomen_metric',$row[0]->abdomen_metric) == 'cm' ? 'selected' : '' ?> value="cm">Centimeters</option>
                                    <option <?= get_var('abdomen_metric', $row[0]->abdomen_metric) == 'inches' ? 'selected' : '' ?> value="inches">Inches</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-column">
                            <label for="abdomen">Abdomen Circumference</label>
                            <input type="text" id="abdomen" name="abdomen" value="<?= get_var('abdomen', $row[0]->abdomen) ?>" required />
                        </div>
                    </div>
