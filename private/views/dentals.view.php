<style>
    /* Centering the SVG within the tooth-chart
.tooth-chart {
    display: flex;
    justify-content: center;
}

/* You may adjust the width of the SVG to fit within the container as needed
svg {
    width: 100%;
            ...
            <form method="post">
                ...
                <div class="form-row">
                    <div class="dental-charting">
                        <div class="chart">
                            <!-- Tooth chart SVG here -->

                            <link rel='stylesheet' href='teeth_eruption.css'>
                            <div class='tooth-chart'>
                                <svg version='1.1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' x='0px' y='0px' viewBox='0 0 450 700' enable-background='new 0 0 450 700' xml:space='preserve'>
                                    <g class='dtfmLabels'>
                                        <text id='txtToothT' transform='matrix(1 0 0 1 1.0001 447.0915)' font-family='' MyriadPro-Regular'' font-size='16px'>20</text>
                                        <text id='txtToothS' transform='matrix(1 0 0 1 23.3102 506.416)' font-family='' MyriadPro-Regular'' font-size='16px'>19</text>
                                        <text id='txtToothR' transform='matrix(1 0 0 1 57.4898 569.9049)' font-family='' MyriadPro-Regular'' font-size='16px'>18</text>
                                        <text id='txtToothQ' transform='matrix(1 0 0 1 109.3098 618.5447)' font-family='' MyriadPro-Regular'' font-size='16px'>17</text>
                                        <text id='txtToothP' transform='matrix(1 0 0 1 173.8689 642.0117)' font-family='' MyriadPro-Regular'' font-size='16px'>16</text>
                                        <text id='txtToothO' transform='matrix(1 0 0 1 236.6671 642.012)' font-family='' MyriadPro-Regular'' font-size='16px'>15</text>
                                        <text id='txtToothN' transform='matrix(1 0 0 1 300.104 618.5447)' font-family='' MyriadPro-Regular'' font-size='16px'>14</text>
                                        <text id='txtToothM' transform='matrix(1 0 0 1 358.7073 569.905)' font-family='' MyriadPro-Regular'' font-size='16px'>13</text>
                                        <text id='txtToothL' transform='matrix(1 0 0 1 393.2542 506.4159)' font-family='' MyriadPro-Regular'' font-size='16px'>12</text>
                                        <text id='txtToothK' transform='matrix(1 0 0 1 405.3402 447.0916)' font-family='' MyriadPro-Regular'' font-size='16px'>11</text>
                                        <text id='txtToothJ' transform='matrix(1 0 0 1 411.0546 240.9981)' font-family='' MyriadPro-Regular'' font-size='16px'>10</text>
                                        <text id='txtToothI' transform='matrix(1 0 0 1 390.5584 186.7916)' font-family='' MyriadPro-Regular'' font-size='16px'>9</text>
                                        <text id='txtToothH' transform='matrix(1 0 0 1 362.0746 133.1618)' font-family='' MyriadPro-Regular'' font-size='16px'>8</text>
                                        <text id='txtToothG' transform='matrix(1 0 0 1 314.9963 97.0455)' font-family='' MyriadPro-Regular'' font-size='16px'>7</text>
                                        <text id='txtToothF' transform='matrix(1 0 0 1 236.6669 69.3723)' font-family='' MyriadPro-Regular'' font-size='16px'>6</text>
                                        <text id='txtToothE' transform='matrix(1 0 0 1 173.869 69.3719)' font-family='' MyriadPro-Regular'' font-size='16px'>5</text>
                                        <text id='txtToothD' transform='matrix(1 0 0 1 111.8719 90.5134)' font-family='' MyriadPro-Regular'' font-size='16px'>4</text>
                                        <text id='txtToothC' transform='matrix(1 0 0 1 59.4649 141.1669)' font-family='' MyriadPro-Regular'' font-size='16px'>3</text>
                                        <text id='txtToothB' transform='matrix(1 0 0 1 25.25 184.2726)' font-family='' MyriadPro-Regular'' font-size='16px'>2</text>
                                        <text id='txtToothA' transform='matrix(1 0 0 1 7.6667 247.2726)' font-family='' MyriadPro-Regular'' font-size='16px'>1</text>
                                    </g>
                                    <g class='spots'>
                                        <polygon id='ToothT' fill='#FFFFFF' data-key='20' points='65.7,373.5 74,375.2 82,380.8 86.3,384.8 90.3,390.2 92.7,395.8 93,404.8 93,416.8 
                                ...
                                36.3,425.2 33.3,407.8 34.3,399.5 36,392.8 39.7,383.5 47,377.2 57,373.2 	' />
                                        <polygon id='ToothS' fill='#FFFFFF' data-key='19' points='93.7,456.2 82.7,455.8 70.7,460.8 66.3,467.2 63.7,474.2 62,487.2 63.3,500.2 
                                ...
                                114.3,484.5 108.7,470.8 103,462.5 	' />
                                        <polygon id='ToothR' fill='#FFFFFF' data-key='18' points='129.3,532.2 137,535.2 142.7,541.2 146,548.8 147.7,557.8 144.7,565.2 136.7,570.5 
                                123,573.8 113,574.2 105,572.8 101.3,564.8 103,551.2 107.3,541.2 111.3,535.5 124,531.5 	' />
                                        <polygon id='ToothQ' fill='#FFFFFF' data-key='17' points='164.3,564.5 168.3,568.8 173,592.2 172,598.2 169.3,601.8 162,601.8 152,599.8 
                                142.3,595.5 131,586.8 130.7,584.5 135,575.8 140.3,570.2 149.7,564.5 159,562.8 	' />
                                        <polygon id='ToothP' fill='#FFFFFF' data-key='16' points='208,576.5 218,607.2 214,611.5 206.7,613.2 191,612.8 179,606.8 172.3,601.5 
                                174,597.8 190.3,578.2 199.7,571.8 205.7,573.8 	' />
                                        <polygon id='ToothO' fill='#FFFFFF' data-key='15' points='244.3,574.2 235.7,575.2 230.7,581.8 225.7,593.5 221.7,604.5 220.3,609.8 224,613.5 
                                234.3,615.5 248.7,613.8 258.7,610.8 264,606.2 265.3,598.8 	' />
                                        <polygon id='ToothN' fill='#FFFFFF' data-key='14' points='306.3,575.8 298.7,569.2 289.7,566.2 280.7,564.2 275.3,566.8 272,572.2 268.7,583.8 
                                267.3,593.2 266.3,599.2 266.7,603.8 270.7,607.8 276.3,608.8 286.7,605.2 300,597.5 307.7,590.5 309,583.5 	' />
                                        <polygon id='ToothM' fill='#FFFFFF' data-key='13' points='335,532.2 341.7,546.5 343.3,562.8 339.7,570.5 331.7,573.5 309,572.5 302,569.2 
                                298,564.5 299.7,548.2 303,539.5 307.3,531.8 315.3,525.2 321.3,525.2 325,525.5 	' />
                                        <polygon id='ToothL' fill='#FFFFFF' data-key='12' points='354,450.2 365.7,453.8 377,459.5 384.3,469.2 385,481.5 382.7,491.8 369.7,517.8 
                                357.3,527.8 340.7,532.2 331.7,528.5 324.3,523.5 321,515.2 320.7,504.2 325.3,489.5 330.3,470.2 335,460.5 343.7,453.2 	' />
                                        <polygon id='ToothK' fill='#FFFFFF' data-key='11' points='391.7,370.2 379,367.8 366.7,370.2 356.3,378.8 350.3,388.2 347.7,396.2 348,411.5 
                                ...
                                406.7,413.5 409.7,400.5 408.7,390.5 404.3,380.2 	' />
                                        <polygon id='ToothJ' fill='#FFFFFF' data-key='10' points='384.3,231.2 391.3,232.5 402.3,241.5 409,253.8 414.3,267.2 416,281.8 413.7,300.2 
                                ...
                                351.7,248.2 357.7,239.5 367.7,237.5 	' />
                                        <polygon id='ToothI' fill='#FFFFFF' data-key='9' points='359.3,167.2 367.3,169.8 375.3,182.5 384,199.8 389.7,211.8 389.3,220.5 386,227.5 
                                377.3,233.5 363.3,238.5 355.3,237.5 348.3,233.2 343.3,224.8 337,211.5 330.7,195.8 328,186.8 332.7,175.2 342.7,168.5 	' />
                                        <polygon id='ToothH' fill='#FFFFFF' data-key='8' points='305.7,136.5 303,143.8 301,150.5 304,161.5 313,170.2 323,172.8 331.7,172.5 
                                339.3,168.8 346,162.5 350.3,152.2 351.3,141.2 347.3,134.5 343,132.2 334,131.5 322.3,130.2 316,129.8 	' />
                                        <polygon id='ToothG' fill='#FFFFFF' data-key='7' points='277.3,98.8 276.7,107.2 276,119.2 276,129.5 279.7,138.2 285.7,141.2 293.3,141.5 
                                301.7,135.8 316.7,126.8 320,122.5 320,116.2 316.3,109.8 301.7,101.8 294.7,98.8 282,97.5 	' />
                                        <polygon id='ToothF' fill='#FFFFFF' data-key='6' points='222,87.5 222.7,93.8 226.7,98.2 231,107.8 236.7,121.5 242,125.8 248,126.8 257,120.2 
                                275.3,101.5 276,95.2 273.7,92.2 266,85.8 248.7,80.5 236.3,80.2 229,81.8 	' />
                                        <polygon id='ToothE' fill='#FFFFFF' data-key='5' points='168.3,94.5 172,103.5 175.3,107.5 184,120.5 190.3,127.5 198.7,128.5 203.3,124.8 
                                209.7,115.2 219.7,92.5 218.7,85.8 209,83.8 191.3,82.5 182,84.2 173.7,88.2 	' />
                                        <polygon id='ToothD' fill='#FFFFFF' data-key='4' points='123.7,124.2 131.3,131.2 143.3,137.5 151.3,141.8 159,142.5 165.7,137.5 169.3,125.8 
                                169,108.8 169.7,100.2 165,95.5 158.3,95.2 145.7,97.8 138.7,102.5 130,108.2 124.3,114.2 	' />
                                        <polygon id='ToothC' fill='#FFFFFF' data-key='3' points='106.7,132.2 118,132.2 130.3,132.5 139.7,138.2 144.7,147.8 144.7,160.8 134.3,173.8 
                                121.7,180.2 115,180.2 107.7,174.5 100,169.8 98.7,156.8 97.3,147.8 98.3,138.8 104.7,133.2 	' />
                                        <polygon id='ToothB' fill='#FFFFFF' data-key='2' points='90.2,242.2 97.3,236.1 106.3,224.2 114.9,200.1 117.3,189.4 113,179.1 95.7,169.8 
                                86.2,169.8 71.9,179.1 63.5,191.3 58.6,202.5 54,215.2 55.8,227.2 65.8,238.9 79.1,242.2 	' />
                                        <polygon id='ToothA' fill='#FFFFFF' data-key='1' points='55.2,236.1 60,237.2 69.8,240.2 86.9,243.3 92,247 95.7,255.8 95.7,271.2 94.7,286.5 
                                90.2,305.2 82.8,312.8 72,318.5 56.7,319.3 48.8,317.5 40.8,311.5 33,300.3 31.3,284.7 34.2,273.8 39.3,256.3 42.3,248 	' />
                                    </g>
                                    <g id='child-outlines'>
                                        <g id='XMLID_9_'>
                                            <path id='XMLID_167_' fill='#ad9797' d='M67.9,257.2c0.1-0.5-0.5-1-0.9-0.8l0-0.1c-0.4,0.6-0.4,1.4,0,2
                                                    C67.4,258,67.8,257.7,67.9,257.2z' />
                                            <path id='XMLID_145_' fill='#ad9797' d='M391.2,293.4c0.2,0.6,1.1,1.1,1.6,0.6c1.1-0.9,0.1-3.1-1.3-2.9l0,0.4
                                                    C391.3,292.1,391,292.8,391.2,293.4z' />
                                            <path id='XMLID_144_' fill='#ad9797' d='M90.4,191.3c-0.6,0.7,0.3,1.9,1.3,2l0.2-0.2c0.9,0.9,2.7-0.8,1.8-1.8
                                                    C92.6,191.3,91.5,191.3,90.4,191.3z' />
                                            <path id='XMLID_143_' fill='#ad9797' d='M63.6,393.6c1,0.1,2-0.9,1.9-1.9c-0.1-1-1.3-1.8-2.3-1.4l0.1,0.5
                                                    C63.4,391.7,63.5,392.6,63.6,393.6z' />
                                            <path id='XMLID_142_' fill='#ad9797' d='M380.9,401c-1,1.3-1,3.2,0,4.5c1.8,2.5,0.9,6-0.5,8.8c-1.4,2.7-3.4,5.4-3.5,8.5
                                            ...
                                            <path id='XMLID_141_' fill='#ad9797' d='M94.8,506.7c0.2,1,1.5,1.6,2.4,1c-0.3-0.8-0.5-1.7-0.8-2.5l0.2-0.4
                                                    C95.6,504.7,94.6,505.7,94.8,506.7z' />
                                            <path id='XMLID_140_' fill='#ad9797' d='M352.5,484c1-0.4,1.9-1.3,2.3-2.3c-0.6-0.7-1.8-0.7-2.5,0c-0.6,0.7-0.6,1.9,0.1,2.5
                                                    L352.5,484z' />
                                            <path id='XMLID_139_' fill='#ad9797' d='M75.9,434.2c-1-0.6-1.9-1.3-2.9-1.9c-2.2-1.5-4.4-2.9-6.6-4.4c-0.7-0.5-0.5-1.6-0.2-2.5
                                            ...
                                            <path id='XMLID_138_' fill='#ad9797' d='M155.2,105.8c-0.6-1.3-2.3-2-3.6-1.5l0,0.1c-1,0.3-1.7,1.4-1.4,2.4
                                                    C151.9,107,153.7,106.7,155.2,105.8z' />
                                            <path id='XMLID_137_' fill='#ad9797' d='M82.5,186.8c0.6,1.3,1.5,2.4,2.7,3.2l0,0.1c0.6-0.1,1.1-0.3,1.7-0.4
                                                    C86.3,188,84.4,186.7,82.5,186.8z' />
                                            <path id='XMLID_136_' fill='#ad9797' d='M361.4,216.8l0.5-0.8c2.1-0.5,2-4.2-0.1-4.6C360.5,212.9,360.4,215.2,361.4,216.8z' />
                                            <path id='XMLID_135_' fill='#ad9797' d='M355.9,500.4c1.7-2.7,3.5-5.7,6.5-6.7c1.4-0.4,3.3-0.8,3.3-2.2c0-1.6-2.5-1.7-3.9-1
                                                    c-4.1,2-6.9,5.9-9.5,9.7c-1.3,1.8-2.6,3.6-3.8,5.5C351.6,505.8,354.2,503.1,355.9,500.4z' />
                                            <path id='XMLID_134_' fill='#ad9797' d='M386.1,264.8c-0.5,1.9,0.5,4.2,2.3,5.1c0.7,0.1,1.3-0.9,0.8-1.4l0.1,0
                                                    C388.2,267.3,387.2,266,386.1,264.8z' />
                                            <path id='XMLID_133_' fill='#ad9797' d='M63.5,402.1c1,1,2.6,1.2,3.8,0.6c-0.8-2-2.1-4.4-4.2-4.6l0.1,0.2
                                                    C62.4,399.4,62.6,401.1,63.5,402.1z' />

                                            <!-- TEETH OUTLINE FOR UPPER TEETH -->
                                            <path id='XMLID_116_' fill='#ad9797' d='M417.3,277.6c0-1.2-0.2-2.7-0.6-3.8c0.3-2.8-0.4-5.4-1.4-8c-0.3-2.5-1.1-4.9-2.4-7
                                            ...
                                            <!-- TEETH OUTLINE FOR LOWER TEETH -->
                                            <path id='XMLID_80_' fill='#ad9797' d='M401.6,375c-9.8-10-27.2-12.3-38.5-3.9c-3.9,2.9-6.9,6.7-9.9,10.5c-2,2.6-4.1,5.2-5.2,8.4
                                            ...
                                            <path id='XMLID_79_' fill='#ad9797' d='M76.3,413.6l0.3-0.2c-0.9-2.2-2.4-4.9-4.8-4.9c0.9,2.4,2.2,4.6,3.8,6.5
                                                            C76.2,415.1,76.7,414.1,76.3,413.6z' />
                                            <path id='XMLID_78_' fill='#ad9797' d='M366.2,207.5c1.4,0.5,3,0.2,4.2-0.8c-0.6-1.7-2.6-2.7-4.4-2.3c0.1-1.1-0.5-2.2-1.5-2.8
                                                            c-0.6,2.1-0.9,4.3-0.9,6.5c0.8,0.2,1.8,0,2.4-0.7L366.2,207.5z' />
                                            <path id='XMLID_77_' fill='#ad9797' d='M134,117.5c0.3,0,0.5-0.1,0.7-0.3c4.2-2.6,8.5-5.2,12.7-7.8c1.1-0.7,2.4-2.1,1.6-3.1
                                                            c-5.6,1.8-10.7,4.9-14.9,8.9C133.4,115.9,133,117.4,134,117.5z' />
                                            <path id='XMLID_76_' fill='#ad9797' d='M66.4,278.5c0.5-0.1,0.9-0.1,1.4-0.2c0.1-5.3,9.1-6.1,10.1-11.3c-1-0.4-2.2,0.3-3.1,0.9
                                                            c-1.6,1.1-3.2,2.1-4.8,3.2c-1.3,0.9-2.6,1.8-3.5,3.1C65.7,275.4,65.5,277.3,66.4,278.5z' />
                                            <path id='XMLID_75_' fill='#ad9797' d='M101.2,492c-1.5,0.6-3,1.2-4.5,1.8c-1.2,0.5-1.8,2-1.7,3.3s0.8,2.5,1.5,3.7
                                                            c-0.2-1.3,1-2.7,2.3-2.7C99.6,496.1,100.4,494,101.2,492z' />
                                            <path id='XMLID_74_' fill='#ad9797' d='M64.2,264.8c-4.4,3.1-8.4,6.7-11.7,10.9c3.8-1.2,7.4-3.2,10.3-6
                                                            C64.2,268.5,65.5,266.2,64.2,264.8z' />
                                            <path id='XMLID_72_' fill='#ad9797' d='M378.4,399.1c0.9-0.9,1.3-2.2,1.7-3.4c1.1-3.5,2.3-7,3.4-10.5c-2-0.6-3.7,1.6-4.6,3.5
                                                            c-1.7,3.5-3,7.3-3.8,11.1C376.1,400.5,377.5,400,378.4,399.1z' />
                                            <path id='XMLID_71_' fill='#ad9797' d='M372.2,251.4c1.3,2.2,2.7,4.5,3.1,7.1c0.4,2.6-0.3,5.5-2.4,7c0,1.3,2.2,1.1,2.9,0
                                                            c0.7-1.1,0.8-2.7,1.9-3.4c0.5-0.3,1.1-0.4,1.6-0.8c0.4-0.4,0.5-1.1,0.6-1.7C380,255.4,376.3,251.5,372.2,251.4z' />
                                            <path id='XMLID_69_' fill='#ad9797' d='M194.1,93.7c0.6-0.1,1.3-0.3,1.7-0.8c0.4-0.5,0.3-1.4-0.3-1.6c-5.5-1.9-12-0.5-16.3,3.4
                                                            C184.2,95.1,189.2,94.7,194.1,93.7z' />
                                            <path id='XMLID_68_' fill='#ad9797' d='M358.2,479.7c0.2-0.2,0.3-0.5,0.4-0.8c1.6-4,3.1-8.1,4.7-12.1c-1.2-0.9-3,0.3-3.5,1.8
                                                            c-0.5,1.4-0.4,3.1-1.1,4.4c-0.5,1-1.4,1.8-2.1,2.6c-0.7,0.9-1.3,2-1,3.1S357.4,480.6,358.2,479.7z' />
                                            <path id='XMLID_66_' fill='#ad9797' d='M58.2,407.8c-1.5-0.2-2.8,0.9-3.9,1.9c-0.9,0.8-1.8,1.7-2.6,2.5c-1,1-1.8,3.1-0.4,3.4
                                                            c2.4-2,5-3.6,7.9-4.7C60.5,410.3,59.7,407.9,58.2,407.8z' />
                                            <path id='XMLID_65_' fill='#ad9797' d='M381.6,281.6c-0.7,0.4-1.3,0.8-1.9,1.3c1.3-0.1,2.7,0.2,3.8,0.9c2.3,1.4,4.4,4.3,7,3.5
                                                            C390.8,283.1,385.4,279.7,381.6,281.6z' />
                                            <path id='XMLID_64_' fill='#ad9797' d='M262,97.4c-0.7-1.9-2.9-2.6-4.9-3.2c-2.7-0.7-5.5-1.5-8.2-2.2c-0.9-0.2-1.8-0.5-2.6-0.2
                                                            c-0.8,0.3-1.5,1.3-1,2.1C250.7,91.9,256.3,98.7,262,97.4z' />
                                            <path id='XMLID_63_' fill='#ad9797' d='M75.5,208.2c-1.7-0.1-4,0.9-3.4,2.4c5,0.3,9.9,1.9,14.1,4.5
                                                            C85.2,210.7,80.1,208.5,75.5,208.2z' />
                                            <path id='XMLID_62_' fill='#ad9797' d='M358.7,193c-1.7,1-2.3,3-2.7,4.9c-0.4,1.5-0.7,3-1.1,4.5c0.9,0.4,1.8-0.4,2.5-1.2
                                                            c1.4-1.6,2.9-3.2,4.3-4.8c0.3-0.4,0.6-0.7,0.8-1.2C363.1,193.4,360.3,192,358.7,193z' />
                                            <path id='XMLID_61_' fill='#ad9797' d='M86.9,492.7c2.8-4.6,3.3-10.5,1.3-15.5c-0.5-1.3-2.1-2.8-3.1-1.7
                ...
                <div class="form-row">
                    <div class="form-column">
                        <label for="fillings">Type of Filling:</label>
                        <div class="select-wrapper">
                            <select id="fillings" name="fillings" required>
                                <option value="" disabled <?= get_var('type') == '' ? 'selected' : '' ?>>Select</option>
                                <option value="amalgam">Amalgam (Silver Filling)</option>
                                <option value="composite">Composite (Tooth-Colored Resin)</option>
                    ...
                    <div class="form-column">
                        <label for="crowns">Type of Crowns:</label>
                        <div class="select-wrapper">
                            <select id="crowns" name="crowns" required>
                                <option value="" disabled <?= get_var('type') == '' ? 'selected' : '' ?>>Select</option>
                                <option value="stainless_steel">Stainless Steel</option>
                                <option value="metal">Metal</option>
                                <option value="porcelain_fused_to_metal">Porcelain-Fused-to-Metal</option>
                                <option value="all_resin">All-Resin</option>
                                <option value="all_ceramic">All-Ceramic or All-Porcelain</option>
                                <option value="zirconia">Zirconia</option>
                                <option value="e_max">E-Max</option>
                                <option value="temporary">Temporary Crown</option>
                            </select>
                        </div>
                    </div>

                    <div class="form-column">
                        <label for="bridges">Type of Bridges:</label>
                        <div class="select-wrapper">
                            <select id="bridges" name="bridges" required>
                                <option value="" disabled <?= get_var('type') == '' ? 'selected' : '' ?>>Select</option>
                                <option value="traditional">Traditional Bridge</option>
                                <option value="cantilever">Cantilever Bridge</option>
                                <option value="maryland_bonded">Maryland Bonded Bridge</option>
                                <option value="implant_supported">Implant-Supported Bridge</option>
                                <option value="composite">Composite Bridge</option>
                                <option value="temporary">Temporary Bridge</option>
                            </select>
                        </div>
                    </div>

                    <div class="form-column">
                        <label for="dental_implants">Type of Dental Implants:</label>
                        <div class="select-wrapper">
                            <select id="dental_implants" name="dental_implants" required>
                                <option value="" disabled <?= get_var('type') == '' ? 'selected' : '' ?>>Select</option>
                                <option value="endosteal">Endosteal Implant</option>
                                <option value="subperiosteal">Subperiosteal Implant</option>
                                <option value="all_on_4">All-on-4 Implant</option>
                                <option value="mini">Mini Dental Implant (MDI)</option>
                                <option value="immediate_load">Immediate Load Dental Implant</option>
                                <option value="zygomatic">Zygomatic Implant</option>
                                <option value="implant_supported_bridge">Implant-Supported Bridge</option>
                                <option value="implant_retained_denture">Implant-Retained Denture</option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="form-row">
                    <div class="form-column" id="resultField">
                        ...
                        <input type="text" id="observations" name="observations" value="<?= get_var('result') ?>" />
                    </div>
                </div>
...
<script>
    // JavaScript for tooth chart interactions
    const teeth = document.querySelectorAll('.spots polygon, .spots path');
    const teethNumberInput = document.getElementById('tooth_number');
    let selectedTooth = null;

    teeth.forEach(tooth => {
        tooth.addEventListener('click', () => {
            // Reset the color of previously selected tooth and clear the input
            if (selectedTooth) {
                selectedTooth.style.fill = '#FFFFFF'; // Reset the previously selected tooth color
                teethNumberInput.value = ''; // Clear the input field
            }

            // If the clicked tooth is not the current selectedTooth, change color and update input
            if (selectedTooth !== tooth) {
                tooth.style.fill = '#7a5be9'; // Change color of the selected tooth
                selectedTooth = tooth; // Store the current selected tooth
                teethNumberInput.value = tooth.dataset.key; // Update the input field with the tooth number
            } else {
                selectedTooth = null; // Deselect tooth
            }
        });
    });
    ...
    function showHistory() {
        ...
        historyPopup.style.left = `${window.innerWidth / 2 - historyPopup.offsetWidth / 2}px`;
        historyPopup.style.top = `${window.innerHeight / 2 - historyPopup.offsetHeight / 2}px`;
    }

    document.addEventListener('click', (event) => {
        if (!historyPopup.contains(event.target) && event.target !== historyPopup) {
