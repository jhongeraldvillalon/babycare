            ...
            <form method="post">
                    ...
                    <div class="form-column">
                        ...
                        <div class="select-wrapper">
                            <select id="type" name="type" required>
                                <option value="" disabled <?= get_var('type') == '' ? 'selected' : '' ?>>Select</option>
                                <option value="accident" <?= get_var('type') == 'accident' ? 'selected' : '' ?>>Accident</option>
                                <option value="sickness" <?= get_var('type') == 'sickness' ? 'selected' : '' ?>>Sickness</option>
                            </select>
                        </div>
                    </div>>
                </div>
                <div class="form-row">
                    <div class="form-column">
                        ...
                        <input type="text" id="condition" name="condition" value="<?= get_var('condition') ?>" required />
                    </div>
                    <div class="form-column">
                        <label for="is_consult">Is this event already consulted?</label>
                        <input type="checkbox" id="consultedCheckbox" name="is_consult" value="1" onchange="toggleResultField()" />
                    </div>
                ...
                <div class="form-row">
                    <div class="form-column" id="resultField">
                        ...
                        <input type="text" id="result" name="result" value="<?= get_var('result') ?>" />
                    </div>
                </div>
